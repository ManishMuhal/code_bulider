                            ...
                            <div className="thumb-banner">
                                <div className="shape1 ani9">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={20} height={255} viewBox="0 0 20 255" fill="none">
                                        <path d="M1.04052 17.3472L10.0151 0C11.2529 2.21454 18.6826 16.7979 18.9896 17.3472C19.9181 19.0082 21.2692 25.3321 17.4423 29.8963C13.7287 34.3254 8.15831 36.1708 2.89733 30.2654C-1.18999 25.6774 -0.0941967 19.8078 1.04052 17.3472Z" fill="#FF9800" />
                                        <circle r={3} transform="matrix(1 0 0 -1 9.5 227.5)" fill="#FF9800" stroke="#FF9800" />
                                        <circle r={3} transform="matrix(1 0 0 -1 9.5 251.5)" fill="#FF9800" stroke="#FF9800" />
                                        <line y1={-1} x2={152} y2={-1} transform="matrix(4.37114e-08 -1 -1 -4.37114e-08 9 205)" stroke="#FF9800" strokeWidth={2} />
                                    </svg>
                                </div>
                                <div className="thumb">
                                    <img src="/assets/images/banner/thumb-banner.png" width={'500px'}
                        ...
                        <div className="col-md-6">
                            <div className="content-banner">
                                ...
                                {/* <div className="group-btn wow fadeInUp">
                                    ...
                                    <Link href="/item-details" className="tf-button style-3 btn-2">Sell Item</Link>
                                </div> */}
                                <div className="shape ani4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={176} height={143} viewBox="0 0 176 143" fill="none">
                                        <path d="M77.3294 126.162C55.2085 124.134 9.25963 110.354 2.43137 71.4571C0.743732 62.3166 4.23102 40.7095 31.6813 27.4047" stroke="#FF9800" strokeWidth={3} />
                                        ...
                                        <path d="M42.074 15.4582L50.5959 0.701185C51.713 2.61761 58.4014 15.2279 58.6785 15.7033C59.5164 17.1407 60.6862 22.5834 57.0882 26.4461C53.5967 30.1945 48.4203 31.7013 43.6282 26.5641C39.9052 22.573 40.9932 17.5533 42.074 15.4582Z" fill="#FF9800" />
