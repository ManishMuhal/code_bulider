...
const Countdown = ({ endDateTime, styleCls, style, showDay }) => {
    ...
    return (
        <>
            {style === 2 ? <>
                <span class={`js-countdown ${styleCls ? styleCls : ""}`}>
                    <div aria-hidden="true" className="countdown__timer">
                        <span className="countdown__item" style={{ display: `${showDay ? "inline-flex" : "none"}` }}>
                ...
                <span class={`js-countdown ${styleCls ? styleCls : ""}`}>
                    <div aria-hidden="true" className="countdown__timer">
                        <span className="countdown__item" style={{ display: "none" }}>
                            <span className="countdown__value countdown__value--0 js-countdown__value--0">{timeParts.days}</span><span className="countdown__label">d</span>
                        </span>
                        <span className="countdown__item">
                            <span className="countdown__value countdown__value--1 js-countdown__value--1">{timeParts.hours}</span><span className="countdown__label">h
                            </span>
                        </span>
                        <span className="countdown__item">
                            <span className="countdown__value countdown__value--2 js-countdown__value--2">{timeParts.minutes}</span><span className="countdown__label">m
                            </span>
                        </span>
                        <span className="countdown__item">
                            <span className="countdown__value countdown__value--3 js-countdown__value--3">{timeParts.seconds}</span><span className="countdown__label">s
                            </span>
                        </span>
                    </div>
                </span>
