                        ...
                        <div className="detail-wrap">
                            <div className="detail-inner">
                                ...
                                <div className="image style-2">
                                    <img className="mr20" src="/assets/images/blog/blog-details-6.jpg" alt="Image" />
                                ...
                                <div className="content-bottom">
                                    <div className="widget widget-socical">
                                        ...
                                        <ul>
                                            <li><Link href="#" className="icon-fl-mess" /></li>
                                            <li><Link href="#" className="icon-fl-coolicon" /></li>
                                            <li><Link href="#" className="icon-fl-facebook" /></li>
                                        </ul>
                                    </div>
                                ...
                                <div id="comments">
                                    ...
                                    <form action="contact/contact-process.php" method="post" id="commentform" className="comment-form">
                                        ...
                                        <fieldset className="message"><textarea id="message" name="message" rows={4} placeholder="Message" tabIndex={4} aria-required="true" required /></fieldset><div className="btn-submit mg-t-36"><button className="tf-button" type="submit">Send comment</button></div></form></div>
                            </div>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div className="post-content">
                                                <h6 className="title"><Link href="/blog-details">6 Make Mobile Website Faster </Link></h6>
