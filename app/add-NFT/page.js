...
import Wishlist from "@/components/elements/Wishlist"
...
export default function AddNft() {
    ...
    return (
        <>
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Add New NFT" breadcrumbHeading>
                        ...
                        <div className="row ">
                            <div className="col-xl-9 col-lg-8 ">
                                <div className="add-nft-inner">
                                    ...
                                    <p className="sub">Connect With One Of Our Available Wallet Providers Or Create A New One.</p>
                                    <ul className="blockchain-button">
                                        <li><Link href="#"><img src="/assets/images/svg/metamask.svg" alt="Image" />MetaMask</Link></li>
                                        <li><Link href="#"><img src="/assets/images/svg/coinbase.svg" alt="Image" />Coinbase</Link></li>
                                        <li><Link href="#"><img src="/assets/images/svg/torus.svg" alt="Image" />Torus</Link></li>
                                        <li><Link href="#"><img src="/assets/images/svg/fortmatic.svg" alt="Image" />Fortmatic</Link></li>
                                        <li><Link href="#">Show more options</Link></li>
                                    </ul>
                                    ...
                                    <div className="tf-tab">
                                        <ul className="create-button menu-tab">
                                            <li className={isTab === 1 ? " active" : ""} onClick={() => handleTab(1)}>
                                            ...
                                            <li className={isTab === 2 ? " active" : ""} onClick={() => handleTab(2)}>
                                                <div className="create-item">
                                        ...
                                        <div className="content-tab">
                                            <div className={isTab === 1 ? "content-inner active" : "content-inner"} style={{ display: `${isTab == 1 ? "block" : "none"}` }}>
                                                <div className="tab-create-item">
                                                    ...
                                                    <fieldset className="propertise">
                                                        ...
                                                        <ul className="propertise-list">
                                                            <li><Link href="#">Art<i className="fal fa-times" /></Link></li>
                                                            <li><Link href="#">Body type<i className="fal fa-times" /></Link></li>
                                                            <li><Link href="#">Face color<i className="fal fa-times" /></Link></li>
                                                        </ul>
                                                    </fieldset>
                                                    ...
                                                    <ul className="create-collection">
                                                        <li className="active">
                                                            <div className="create-item">
                                                                <div className="img"><i className="fal fa-plus" /></div>
                                                        ...
                                                        <li>
                                                            <div className="create-item">
                                                                <div className="img"><img src="/assets/images/collection/add-collection.jpg" alt="Image" /></div>
                                                                <div className="content">
                                                    ...
                                                    <div className="bottom-button">
                                                        <Link href="#" className="tf-button active">Publish</Link>
                                                        <Link href="#" className="tf-button">Discard all</Link>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className={isTab === 2 ? "content-inner active" : "content-inner"} style={{ display: `${isTab == 2 ? "block" : "none"}` }}>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div className="sc-product style1">
                                    <div className="top">
                                        <Link href="#" className="tag">Sweet Baby #1</Link>
                                        <Wishlist />
                                    </div>
                                    ...
                                    <div className="bottom">
                                        <div className="details-product">
                                            <div className="author">
                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="name"> <Link href="#">Carly Webster</Link></div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="product-button">
                                            <Link href="#" data-toggle="modal" data-target="#popup_bid" className="tf-button"> <span className="icon-btn-product" /> Place Bid</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
